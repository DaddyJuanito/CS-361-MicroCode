...
app.get("/books", (req, res) => {
  // Clears the current data base.
  books.dropDatabase();                             

  // Initialize default lexile range
  let lexile_min = -650;    // Lowest lexile api can process. DO NOT CHANGE.
  let lexile_max = 2150;    // Highest lexile api can process. DO NOT CHANGE.
